...
% modified 03/09/18   S.M. Rump  cpair added
% modified 03/10/18   S.M. Rump  dd added
% modified 03/20/18   S.M. Rump  awa added (thanks to Florian Buenger)
% modified 06/18/18   S.M. Rump  suppress output
% modified 07/11/18   S.M. Rump  taylormodel added (thanks to Florian Buenger)
% modified 07/20/18   S.M. Rump  gfp toolbox added
% modified 07/21/18   S.M. Rump  typo
% modified 08/29/18   S.M. Rump  capitals
%
...
%%%%%%%%%% [Careful: fl-package must be after intval, otherwise set/getround shadowed]
  ...
  addpath( [ INTLABPATH 'ODE' ] );
  addpath( [ INTLABPATH 'ODE' filesep 'awa' ] );
  addpath( [ INTLABPATH 'ODE' filesep 'taylormodel' ] );
  addpath( [ INTLABPATH 'ODE' filesep 'iv' ] );
...
%%%%%%%%%% initialize taylorcoeff toolbox

  taylorcoeffinit;


%%%%%%%%%% initialize taylormodel toolbox
