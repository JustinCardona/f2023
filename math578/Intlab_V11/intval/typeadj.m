...
%
%    typeof(a)\TYPE  |    d     i      f      fi       c     dd      a      g      gi      ga       h      hi     ha       s      p      pi      t     ti      ta
%  -------------------------------------------------------------------------------------------------------------------------------------------------------------------
%         d          |    *    i(A)   f(A)  f(i(A))   c(A)  dd(A)   a(A)   g(A)  g(i(A)) g(a(A))   h(A)  h(i(A)) h(a(A))  s(A)   p(A)   p(i(A)) t(A) t(i(A))  t(a(A))
%         i          |   m(A)   *    f(m(A)) f(A)      -      -     a(A) g(m(A))  g(A)   g(a(A)) h(m(A))  h(A)   h(a(A))  s(A)  p(m(A))  p(A)  t(m(A)) t(A)   t(a(A)) 
%         f          |   d(A) i(d(A))  *     i(A)     c(A)  dd(A)     -      -       -      -        -      -       -      -      -      -       -      -       - 
%         fi         | m(d(A)) d(A)   m(A)     *       -      -       -      -       -      -        -      -       -      -      -      -       -      -       -
%         c          |   d(A) i(d(A)) f(A) f(i(d(A)))  *    dd(A)     -      -       -      -        -      -       -      -      -      -       -      -       - 
%        dd          |   d(A) i(d(A)) f(A) f(i(d(A))) c(A)    *       -      -       -      -        -      -       -      -      -      -       -      -       -
