...
% containing the transcendental number pi. Third, y is an interval vector 
...
%%
% there are three roots, and the inclusions are of high accuracy. One can
...
% g(x):=f(x)-e has a truly double root in X(1). Note the accuracy of the inclusions.
