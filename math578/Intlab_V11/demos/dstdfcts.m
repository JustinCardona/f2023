...
% In previous releases of Matlab, the accuracy of the gamma function near
% negative integers was very poor, sometimes with an error of 100 per cent.
% That was fixed from Matlab release 2018b on. 
%
% However, other problems with the gamma function remain.
% Consider
...
%%
% Obviously gamma(x) must be very small in absolute value. In contrast,
% the Matlab result is infinity. Moreover,
...
%%
% still produces +infinity in Matlab, whereas the sign must change from
% each integer interval to the next.
