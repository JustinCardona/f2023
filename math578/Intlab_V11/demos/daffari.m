...
% proper action, the result of affari arithmetic is worse than ordinary
% interval arithmetic. 
%
% If in the example the reciprocal of A*A is taken, this leads to an
...
%% Rounding errors
% Inevitably, floating-point operations are afflicted with rounding errors.
