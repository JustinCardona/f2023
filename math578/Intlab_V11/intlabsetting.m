...
% modified 06/18/18     S.M. Rump  add settings
%
  ...
  s = sparsegradient; setting = char( setting , ['sparsegradient(' int2str(s) ');'] );
  s = sparsehessian; setting = char( setting , ['sparsehessian(' int2str(s) ');'] );
