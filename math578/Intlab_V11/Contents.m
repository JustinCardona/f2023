...
% Version 11  September-09-2018   1450 m-files, 57,907 lines of Matlab/Octave code w/o comments 
%                 (99,321 with comments),
%             supported by a test-case library with more than 102,000 lines of Matlab/Octave code w/o comments
%
...
%  ODE          - ode toolbox 
%                   AWA for initial value problems
%                   Taylor models for initial value problems
%                   iv toolbox for operator-free interval operations
...
%  INTLAB_Version_11    - Additions and changes in version 11
...
%    Numerische Mathematik 90, 755-773, 2002.
%
...
%    entire floating-point range. Nonlinear Theory and Its Applications 
%    (NOLTA), IEICE, Vol.E5-N,No.3, July, 2014. 
%
...
%     Scientific Computing (SISC), 31(5):3466-3502, 2009
%
%The linear system solver including inner inclusions is completely redesigned 
%and now based on
%  S.M. Rump. Accurate solution of dense linear systems, Part II: Algorithms 
%    using directed rounding. Journal of Computational and Applied Mathematics 
%    (JCAM), 242:185-212, 2013.
%
...
%  S.M. Rump: Improved componentwise verified error bounds for least squares 
%    problems and underdetermined linear systems, Numerical Algorithms, 
%    66:309-322, 2013.
%
...
%
%Slopes based on
%  R. Krawczyk, A. Neumaier: Interval slopes for rational functions
...
%
%The ODE toolbox is entirely implemented by Florian Buenger. It consists of AWA %based on
%  R. Lohner: Einschliessung der Loesung gewoehnlicher Anfangs- und
%    Randwertaufgaben und Anwendungen, Dissertation, Univ. Karlsruhe, 1988.
%and Lohner's Pascal implementation available from 
%  http://www2.math.uni-wuppertal.de/~xsc/xsc/pxsc_software.html#awa 
%as well as Taylor models based on
% I. Eble, "Ueber Taylor-Modelle", Dissertation at Karlsruhe Institute of 
%    Technology, 2007 (written in German),
% Riot, C++-implementation, http://www.math.kit.edu/ianm1/~ingo.eble/de
% K. Makino, "Rigorous analysis of nonlinear motion in particle accelerators", 
...
% M. Neher, K.R. Jackson, N.S. Nedialkov, "On Taylor model based integration of
%    ODEs", SIAM J. Numer. Anal. 45(1), pp. 236-262, 2007
% F. Buenger, "Shrink wrapping for Taylor models revisited",
%    Numerical Algorithms, pp. 1-17, First Online: 30 Sept. 2017
%Florian Buenger spent very much effort to fight Matlab/Octave's interpretation
%  overhead. In particular he wrote an operator-free interval toolbox "iv" to
%  avoid the significant time penalty when using Matlab/Octave's operator 
%  concept. In INTLAB the latter is used, the price for comfort. 
%
...
% modified 09/09/18     S.M. Rump  Version 11
%
