...
%   y = forward(L,b);
%
%L is assumed to be quadratic lower triangular and nonsingular. b may be matrix of rhs.
%
%Input L may be double, complex, intval, fl, affari, gradient, hessian,
%fl, cpair or dd type.
...
% modified 03/11/18   S.M. Rump   fl, cpair and affari added
