...
%LUWPP        Gaussian elimination with partial pivoting
%
%    [L,U,perm,growth] = luwpp(A);
%
%Input A may be rectangular and double, complex, intval, fl, affari,
%cpair or dd type.
...
% modified 03/11/18     S.M. Rump  cpair and dd added
