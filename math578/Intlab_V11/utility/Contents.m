...
%  solvewtp     - solve linear system with total pivoting
%  luwtp        - LU-decomposition with total pivoting
...
%  random       - Random numbers uniformly distributed in [-1,1] or within specified range
...
%  progress     - displays some popup-window
%
